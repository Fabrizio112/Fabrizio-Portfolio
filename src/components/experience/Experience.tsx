    ...
    return (
        <section id="experience">
            ...
            <section id="experience-container">
                {experience.map(exp => <ExperienceCard key={exp.id} id={exp.id} title={exp.title} date={exp.date} description={exp.description} goals={exp.goals} technologies={exp.technologies} gitHub={exp.gitHub} />)}
            </section>
        </section>);
}

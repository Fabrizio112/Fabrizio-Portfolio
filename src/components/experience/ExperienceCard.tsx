...
function ExperienceCard({ id, title, date, description, goals, technologies, gitHub }: experienceType) {
            ...
            <div className="experience-card-bottom">
                ...
                <div>
                    ...
                    <div className="container-github">
                        <a href={gitHub} className={themeLight ? "color-dark" : "color-light"} target="_blank"><FontAwesomeIcon size="2x" icon={faSquareGithub} /></a>
                    </div>
                </div>
            </div>
        </section>);
